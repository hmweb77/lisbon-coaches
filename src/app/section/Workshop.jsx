...
export default function Workshop() {
  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <dl className="mx-auto pb-12 mt-16 grid max-w-2xl text-center grid-cols-1 gap-x-8 gap-y-16 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
